...
難易度レベル: ${level}
レベル1（漢検2級）: 高校卒業レベルの難しい漢字。日常ではあまり使わない読み方（例: 嗜む、朧月、逼迫、語弊）。小中学生が知っているような簡単な漢字は絶対に出さない。
レベル2（漢検準1級）: 大学受験以上レベル。難読で一般人の多くが読めない（例: 蠢く、囁く、捺印、諜報）。
レベル3（漢検1級）: 漢検1級でも最難関クラスの超難読漢字のみ。漢字学者でも迷うレベル。常用漢字・人名漢字は絶対禁止。JIS第3・第4水準の漢字を積極的に使う（例: 驫、鸛、鑿、爨、纛、蠹、鬱金、魑魅魍魎、蚯蚓、玳瑁）。不正解の選択肢も似た読み方で紛らわしくすること。
